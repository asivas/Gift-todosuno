  ...
  const submitHandler = async (data) => {
    ...
    try {
      ...
      if (username !== undefined) {
        res = await fetch(
          `${process.env.NEXT_PUBLIC_API_BACKEND}auth/createUser/${username}`,
          {
            method: "POST",
            headers: {
      ...
      switch (res.status) {
        ...
        case 409:
          ...
          MySweetAlert.fire("Error", "Email o usuario ya registrado", "error");
          break;
        case 413:
        ...
        case 412:
          ...
          MySweetAlert.fire("Error", "No podes referir mas personas", "error");
          break;
        default:
          console.log("llego el default");
          MySweetAlert.fire("Error", "Error en el server", "error");
          break;
      }
    } catch (error) {
